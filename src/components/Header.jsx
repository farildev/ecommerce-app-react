...
import Logo from "../images/Clarity-Logo.png";
...
function Header() {
  ...
  return (
    <header className={`${isActive ? "bg-main py-4 shadow-md" : "bg-none py-6"}
     fixed w-full z-10 transition-all`} >
      <div className='container flex items-center mx-auto justify-between h-full px-3'>
        <div>
          <Link to={'/'}>
            <div>
